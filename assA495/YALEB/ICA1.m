...
%
% This ICA is not complete that there is something wrong with
%using gram schimitz to find orthogonal vectors tha
% there is something wront about the converge part, sometimes
% it can coverge and sometime it can not.
% so I commment the gram schimtz part to make it runnable
% the result to analysis is under this condition
% the vector calculated using ICA algorithn may not be correct
%
